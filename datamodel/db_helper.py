...
# MessageStatsData
    ...
    def add_default_channels(cls):
        ...
        if not cls.get_channels_exists():
            channels = [ChannelData('1', 73, 'UL', 439712500, 210410, 16, 12, 5, True, True, "DRF1268DS"),
                        ChannelData('2', 73, 'UL', 439762500, 210410, 16, 12, 5, True, True, "DRF1268DS"),
                        ChannelData('3', 73, 'UL', 439812500, 210410, 16, 12, 5, True, True, "DRF1268DS"),
                        ChannelData('4', 73, 'UL', 439862500, 210410, 16, 12, 5, True, True, "DRF1268DS"),
                        ChannelData('5', 73, 'UL', 439912500, 210410, 16, 12, 5, True, True, "DRF1268DS"),
                        ChannelData('6', 73, 'UL', 439962500, 210410, 16, 12, 5, True, True, "DRF1268DS"),
                        ChannelData('1', 134, 'XL', 439712500, 114626, 16, 11, 5, True, True, "DRF1268DS"),
                        ChannelData('2', 134, 'XL', 439762500, 114626, 16, 11, 5, True, True, "DRF1268DS"),
                        ChannelData('3', 134, 'XL', 439812500, 114626, 16, 11, 5, True, True, "DRF1268DS"),
                        ChannelData('4', 134, 'XL', 439862500, 114626, 16, 11, 5, True, True, "DRF1268DS"),
                        ChannelData('5', 134, 'XL', 439912500, 114626, 16, 11, 5, True, True, "DRF1268DS"),
                        ChannelData('6', 134, 'XL', 439962500, 114626, 16, 11, 5, True, True, "DRF1268DS"),
                        ChannelData('1', 244, 'L', 439712500, 62950, 16, 10, 5, True, True, "DRF1268DS"),
                        ChannelData('2', 244, 'L', 439762500, 62950, 16, 10, 5, True, True, "DRF1268DS"),
                        ChannelData('3', 244, 'L', 439812500, 62950, 16, 10, 5, True, True, "DRF1268DS"),
                        ChannelData('4', 244, 'L', 439862500, 62950, 16, 10, 5, True, True, "DRF1268DS"),
                        ChannelData('5', 244, 'L', 439912500, 62950, 16, 10, 5, True, True, "DRF1268DS"),
                        ChannelData('6', 244, 'L', 439962500, 62950, 16, 10, 5, True, True, "DRF1268DS"),
                        ChannelData('1', 439, 'ML', 439712500, 34988, 16, 9, 5, True, True, "DRF1268DS"),
                        ChannelData('2', 439, 'ML', 439762500, 34988, 16, 9, 5, True, True, "DRF1268DS"),
                        ChannelData('3', 439, 'ML', 439812500, 34988, 16, 9, 5, True, True, "DRF1268DS"),
                        ChannelData('4', 439, 'ML', 439862500, 34988, 16, 9, 5, True, True, "DRF1268DS"),
                        ChannelData('5', 439, 'ML', 439912500, 34988, 16, 9, 5, True, True, "DRF1268DS"),
                        ChannelData('6', 439, 'ML', 439962500, 34988, 16, 9, 5, True, True, "DRF1268DS"),
                        ChannelData('1', 781, 'MS', 439712500, 19667, 16, 8, 5, True, True, "DRF1268DS"),
                        ChannelData('2', 781, 'MS', 439762500, 19667, 16, 8, 5, True, True, "DRF1268DS"),
                        ChannelData('3', 781, 'MS', 439812500, 19667, 16, 8, 5, True, True, "DRF1268DS"),
                        ChannelData('4', 781, 'MS', 439862500, 19667, 16, 8, 5, True, True, "DRF1268DS"),
                        ChannelData('5', 781, 'MS', 439912500, 19667, 16, 8, 5, True, True, "DRF1268DS"),
                        ChannelData('6', 781, 'MS', 439962500, 19667, 16, 8, 5, True, True, "DRF1268DS"),
                        ChannelData('1', 1367, 'S', 439712500, 11236, 16, 7, 5, True, True, "DRF1268DS"),
                        ChannelData('2', 1367, 'S', 439762500, 11236, 16, 7, 5, True, True, "DRF1268DS"),
                        ChannelData('3', 1367, 'S', 439812500, 11236, 16, 7, 5, True, True, "DRF1268DS"),
                        ChannelData('4', 1367, 'S', 439862500, 11236, 16, 7, 5, True, True, "DRF1268DS"),
                        ChannelData('5', 1367, 'S', 439912500, 11236, 16, 7, 5, True, True, "DRF1268DS"),
                        ChannelData('6', 1367, 'S', 439962500, 11236, 16, 7, 5, True, True, "DRF1268DS"),

                        ChannelData('HAM1', 73, 'UL', 439712500, 210410, 16, 12, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM2', 73, 'UL', 433787500, 210410, 16, 12, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM3', 73, 'UL', 433837500, 210410, 16, 12, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM4', 73, 'UL', 433887500, 210410, 16, 12, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM5', 73, 'UL', 433937500, 210410, 16, 12, 5, True, True, "DRF1268DS"),

                        ChannelData('HAM1', 134, 'XL', 433737500, 114626, 16, 11, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM2', 134, 'XL', 433787500, 114626, 16, 11, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM3', 134, 'XL', 433837500, 114626, 16, 11, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM4', 134, 'XL', 433887500, 114626, 16, 11, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM5', 134, 'XL', 433937500, 114626, 16, 11, 5, True, True, "DRF1268DS"),

                        ChannelData('HAM1', 244, 'L', 433737500, 62950, 16, 10, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM2', 244, 'L', 433787500, 62950, 16, 10, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM3', 244, 'L', 433837500, 62950, 16, 10, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM4', 244, 'L', 433887500, 62950, 16, 10, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM5', 244, 'L', 433937500, 62950, 16, 10, 5, True, True, "DRF1268DS"),

                        ChannelData('HAM1', 439, 'ML', 433737500, 34988, 16, 9, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM2', 439, 'ML', 433787500, 34988, 16, 9, 5, True, True,  "DRF1268DS"),
                        ChannelData('HAM3', 439, 'ML', 433837500, 34988, 16, 9, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM4', 439, 'ML', 433887500, 34988, 16, 9, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM5', 439, 'ML', 433937500, 34988, 16, 9, 5, True, True, "DRF1268DS"),

                        ChannelData('HAM1', 781, 'MS', 433737500, 19667, 16, 8, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM2', 781, 'MS', 433787500, 19667, 16, 8, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM3', 781, 'MS', 433837500, 19667, 16, 8, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM4', 781, 'MS', 433887500, 19667, 16, 8, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM5', 781, 'MS', 433937500, 19667, 16, 8, 5, True, True, "DRF1268DS"),

                        ChannelData('HAM1', 1367, 'S', 433737500, 11236, 16, 7, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM2', 1367, 'S', 433787500, 11236, 16, 7, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM3', 1367, 'S', 433837500, 11236, 16, 7, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM4', 1367, 'S', 433887500, 11236, 16, 7, 5, True, True, "DRF1268DS"),
                        ChannelData('HAM5', 1367, 'S', 433937500, 11236, 16, 7, 5, True, True,  "DRF1268DS"),

                        ChannelData('1', 73, 'UL', 439712500, 210410, 16, 12, 7, False, True, "RAK3172"),
                        ChannelData('2', 73, 'UL', 439762500, 210410, 16, 12, 7, False, True,"RAK3172"),
                        ChannelData('3', 73, 'UL', 439812500, 210410, 16, 12, 7, False, True,"RAK3172"),
                        ChannelData('4', 73, 'UL', 439862500, 210410, 16, 12, 7, False, True,"RAK3172"),
                        ChannelData('5', 73, 'UL', 439912500, 210410, 16, 12, 7, False, True,"RAK3172"),
                        ChannelData('6', 73, 'UL', 439962500, 210410, 16, 12, 7, False, True,"RAK3172"),
                        ChannelData('1', 134, 'XL', 439712500, 114626, 16, 11, 7, False, True,"RAK3172"),
                        ChannelData('2', 134, 'XL', 439762500, 114626, 16, 11, 7, False, True,"RAK3172"),
                        ChannelData('3', 134, 'XL', 439812500, 114626, 16, 11, 7, False, True,"RAK3172"),
                        ChannelData('4', 134, 'XL', 439862500, 114626, 16, 11, 7, False, True,"RAK3172"),
                        ChannelData('5', 134, 'XL', 439912500, 114626, 16, 11, 7, False, True,"RAK3172"),
                        ChannelData('6', 134, 'XL', 439962500, 114626, 16, 11, 7, False, True,"RAK3172"),
                        ChannelData('1', 244, 'L', 439712500, 62950, 16, 10, 7, False, True,"RAK3172"),
                        ChannelData('2', 244, 'L', 439762500, 62950, 16, 10, 7, False, True,"RAK3172"),
                        ChannelData('3', 244, 'L', 439812500, 62950, 16, 10, 7, False, True,"RAK3172"),
                        ChannelData('4', 244, 'L', 439862500, 62950, 16, 10, 7, False, True,"RAK3172"),
                        ChannelData('5', 244, 'L', 439912500, 62950, 16, 10, 7, False, True,"RAK3172"),
                        ChannelData('6', 244, 'L', 439962500, 62950, 16, 10, 7, False, True,"RAK3172"),
                        ChannelData('1', 439, 'ML', 439712500, 34988, 16, 9, 7, False, True,"RAK3172"),
                        ChannelData('2', 439, 'ML', 439762500, 34988, 16, 9, 7, False, True,"RAK3172"),
                        ChannelData('3', 439, 'ML', 439812500, 34988, 16, 9, 7, False, True,"RAK3172"),
                        ChannelData('4', 439, 'ML', 439862500, 34988, 16, 9, 7, False, True,"RAK3172"),
                        ChannelData('5', 439, 'ML', 439912500, 34988, 16, 9, 7, False, True,"RAK3172"),
                        ChannelData('6', 439, 'ML', 439962500, 34988, 16, 9, 7, False, True,"RAK3172"),
                        ChannelData('1', 781, 'MS', 439712500, 19667, 16, 8, 7, False, True,"RAK3172"),
                        ChannelData('2', 781, 'MS', 439762500, 19667, 16, 8, 7, False, True,"RAK3172"),
                        ChannelData('3', 781, 'MS', 439812500, 19667, 16, 8, 7, False, True,"RAK3172"),
                        ChannelData('4', 781, 'MS', 439862500, 19667, 16, 8, 7, False, True,"RAK3172"),
                        ChannelData('5', 781, 'MS', 439912500, 19667, 16, 8, 7, False, True,"RAK3172"),
                        ChannelData('6', 781, 'MS', 439962500, 19667, 16, 8, 7, False, True,"RAK3172"),
                        ChannelData('1', 1367, 'S', 439712500, 11236, 16, 7, 7, False, True,"RAK3172"),
                        ChannelData('2', 1367, 'S', 439762500, 11236, 16, 7, 7, False, True,"RAK3172"),
                        ChannelData('3', 1367, 'S', 439812500, 11236, 16, 7, 7, False, True,"RAK3172"),
                        ChannelData('4', 1367, 'S', 439862500, 11236, 16, 7, 7, False, True,"RAK3172"),
                        ChannelData('5', 1367, 'S', 439912500, 11236, 16, 7, 7, False, True,"RAK3172"),
                        ChannelData('6', 1367, 'S', 439962500, 11236, 16, 7, 7, False, True,"RAK3172"),

                        ChannelData('HAM1', 73, 'UL', 439712500, 210410, 16, 12, 7, False, True,"RAK3172"),
                        ChannelData('HAM2', 73, 'UL', 433787500, 210410, 16, 12, 7, False, True,"RAK3172"),
                        ChannelData('HAM3', 73, 'UL', 433837500, 210410, 16, 12, 7, False, True,"RAK3172"),
                        ChannelData('HAM4', 73, 'UL', 433887500, 210410, 16, 12, 7, False, True,"RAK3172"),
                        ChannelData('HAM5', 73, 'UL', 433937500, 210410, 16, 12, 7, False, True,"RAK3172"),

                        ChannelData('HAM1', 134, 'XL', 433737500, 114626, 16, 11, 7, False, True,"RAK3172"),
                        ChannelData('HAM2', 134, 'XL', 433787500, 114626, 16, 11, 7, False, True,"RAK3172"),
                        ChannelData('HAM3', 134, 'XL', 433837500, 114626, 16, 11, 7, False, True,"RAK3172"),
                        ChannelData('HAM4', 134, 'XL', 433887500, 114626, 16, 11, 7, False, True,"RAK3172"),
                        ChannelData('HAM5', 134, 'XL', 433937500, 114626, 16, 11, 7, False, True,"RAK3172"),

                        ChannelData('HAM1', 244, 'L', 433737500, 62950, 16, 10, 7, False, True,"RAK3172"),
                        ChannelData('HAM2', 244, 'L', 433787500, 62950, 16, 10, 7, False, True,"RAK3172"),
                        ChannelData('HAM3', 244, 'L', 433837500, 62950, 16, 10, 7, False, True,"RAK3172"),
                        ChannelData('HAM4', 244, 'L', 433887500, 62950, 16, 10, 7, False, True,"RAK3172"),
                        ChannelData('HAM5', 244, 'L', 433937500, 62950, 16, 10, 7, False, True,"RAK3172"),

                        ChannelData('HAM1', 439, 'ML', 433737500, 34988, 16, 9, 7, False, True,"RAK3172"),
                        ChannelData('HAM2', 439, 'ML', 433787500, 34988, 16, 9, 7, False, True,"RAK3172"),
                        ChannelData('HAM3', 439, 'ML', 433837500, 34988, 16, 9, 7, False, True,"RAK3172"),
                        ChannelData('HAM4', 439, 'ML', 433887500, 34988, 16, 9, 7, False, True,"RAK3172"),
                        ChannelData('HAM5', 439, 'ML', 433937500, 34988, 16, 9, 7, False, True,"RAK3172"),

                        ChannelData('HAM1', 781, 'MS', 433737500, 19667, 16, 8, 7, False, True,"RAK3172"),
                        ChannelData('HAM2', 781, 'MS', 433787500, 19667, 16, 8, 7, False, True,"RAK3172"),
                        ChannelData('HAM3', 781, 'MS', 433837500, 19667, 16, 8, 7, False, True,"RAK3172"),
                        ChannelData('HAM4', 781, 'MS', 433887500, 19667, 16, 8, 7, False, True,"RAK3172"),
                        ChannelData('HAM5', 781, 'MS', 433937500, 19667, 16, 8, 7, False, True,"RAK3172"),

                        ChannelData('HAM1', 1367, 'S', 433737500, 11236, 16, 7, 7, False, True,"RAK3172"),
                        ChannelData('HAM2', 1367, 'S', 433787500, 11236, 16, 7, 7, False, True,"RAK3172"),
                        ChannelData('HAM3', 1367, 'S', 433837500, 11236, 16, 7, 7, False, True,"RAK3172"),
                        ChannelData('HAM4', 1367, 'S', 433887500, 11236, 16, 7, 7, False, True,"RAK3172"),
                        ChannelData('HAM5', 1367, 'S', 433937500, 11236, 16, 7, 7, False, True,"RAK3172"),

                        # RfBW = 4 => 10.4 kHz
                        ChannelData('1', 73, 'UL', 439700000, 210410, 16, 12, 4, False, True, "RAK3172-2"),
                        ChannelData('2', 73, 'UL', 439725000, 210410, 16, 12, 4, False, True, "RAK3172-2"),
                        ChannelData('3', 73, 'UL', 439750000, 210410, 16, 12, 4, False, True, "RAK3172-2"),
                        ChannelData('4', 73, 'UL', 439775000, 210410, 16, 12, 4, False, True, "RAK3172-2"),
                        ChannelData('5', 73, 'UL', 439800000, 210410, 16, 12, 4, False, True, "RAK3172-2"),
                        ChannelData('6', 73, 'UL', 439825000, 210410, 16, 12, 4, False, True, "RAK3172-2"),
                        ChannelData('7', 73, 'UL', 439850000, 210410, 16, 12, 4, False, True, "RAK3172-2"),
                        ChannelData('8', 73, 'UL', 439875000, 210410, 16, 12, 4, False, True, "RAK3172-2"),
                        ChannelData('9', 73, 'UL', 439900000, 210410, 16, 12, 4, False, True, "RAK3172-2"),
                        ChannelData('10', 73, 'UL', 439925000, 210410, 16, 12, 4, False, True, "RAK3172-2"),
                        ChannelData('11', 73, 'UL', 439950000, 210410, 16, 12, 4, False, True, "RAK3172-2"),
                        ChannelData('12', 73, 'UL', 439975000, 210410, 16, 12, 4, False, True, "RAK3172-2"),

                        ChannelData('1', 134, 'XL', 439700000, 114626, 16, 11, 4, False, True, "RAK3172-2"),
                        ChannelData('2', 134, 'XL', 439725000, 114626, 16, 11, 4, False, True, "RAK3172-2"),
                        ChannelData('3', 134, 'XL', 439750000, 114626, 16, 11, 4, False, True, "RAK3172-2"),
                        ChannelData('4', 134, 'XL', 439775000, 114626, 16, 11, 4, False, True, "RAK3172-2"),
                        ChannelData('5', 134, 'XL', 439800000, 114626, 16, 11, 4, False, True, "RAK3172-2"),
                        ChannelData('6', 134, 'XL', 439825000, 114626, 16, 11, 4, False, True, "RAK3172-2"),
                        ChannelData('7', 134, 'XL', 439850000, 114626, 16, 11, 4, False, True, "RAK3172-2"),
                        ChannelData('8', 134, 'XL', 439875000, 114626, 16, 11, 4, False, True, "RAK3172-2"),
                        ChannelData('9', 134, 'XL', 439900000, 114626, 16, 11, 4, False, True, "RAK3172-2"),
                        ChannelData('10', 134, 'XL', 439925000, 114626, 16, 11, 4, False, True, "RAK3172-2"),
                        ChannelData('11', 134, 'XL', 439950000, 114626, 16, 11, 4, False, True, "RAK3172-2"),
                        ChannelData('12', 134, 'XL', 439975000, 114626, 16, 11, 4, False, True, "RAK3172-2"),

                        ChannelData('1', 244, 'L', 439700000, 62950, 16, 10, 4, False, True, "RAK3172-2"),
                        ChannelData('2', 244, 'L', 439725000, 62950, 16, 10, 4, False, True, "RAK3172-2"),
                        ChannelData('3', 244, 'L', 439750000, 62950, 16, 10, 4, False, True, "RAK3172-2"),
                        ChannelData('4', 244, 'L', 439775000, 62950, 16, 10, 4, False, True, "RAK3172-2"),
                        ChannelData('5', 244, 'L', 439800000, 62950, 16, 10, 4, False, True, "RAK3172-2"),
                        ChannelData('6', 244, 'L', 439825000, 62950, 16, 10, 4, False, True, "RAK3172-2"),
                        ChannelData('7', 244, 'L', 439850000, 62950, 16, 10, 4, False, True, "RAK3172-2"),
                        ChannelData('8', 244, 'L', 439875000, 62950, 16, 10, 4, False, True, "RAK3172-2"),
                        ChannelData('9', 244, 'L', 439900000, 62950, 16, 10, 4, False, True, "RAK3172-2"),
                        ChannelData('10', 244, 'L', 439925000, 62950, 16, 10, 4, False, True, "RAK3172-2"),
                        ChannelData('11', 244, 'L', 439950000, 62950, 16, 10, 4, False, True, "RAK3172-2"),
                        ChannelData('12', 244, 'L', 439975000, 62950, 16, 10, 4, False, True, "RAK3172-2"),

                        ChannelData('1', 439, 'ML', 439700000, 34988, 16, 9, 4, False, True, "RAK3172-2"),
                        ChannelData('2', 439, 'ML', 439725000, 34988, 16, 9, 4, False, True, "RAK3172-2"),
                        ChannelData('3', 439, 'ML', 439750000, 34988, 16, 9, 4, False, True, "RAK3172-2"),
                        ChannelData('4', 439, 'ML', 439775000, 34988, 16, 9, 4, False, True, "RAK3172-2"),
                        ChannelData('5', 439, 'ML', 439800000, 34988, 16, 9, 4, False, True, "RAK3172-2"),
                        ChannelData('6', 439, 'ML', 439825000, 34988, 16, 9, 4, False, True, "RAK3172-2"),
                        ChannelData('7', 439, 'ML', 439850000, 34988, 16, 9, 4, False, True, "RAK3172-2"),
                        ChannelData('8', 439, 'ML', 439875000, 34988, 16, 9, 4, False, True, "RAK3172-2"),
                        ChannelData('9', 439, 'ML', 439900000, 34988, 16, 9, 4, False, True, "RAK3172-2"),
                        ChannelData('10', 439, 'ML', 439925000, 34988, 16, 9, 4, False, True, "RAK3172-2"),
                        ChannelData('11', 439, 'ML', 439950000, 34988, 16, 9, 4, False, True, "RAK3172-2"),
                        ChannelData('12', 439, 'ML', 439975000, 34988, 16, 9, 4, False, True, "RAK3172-2"),

                        ChannelData('1', 781, 'MS', 439700000, 19667, 16, 8, 4, False, True, "RAK3172-2"),
                        ChannelData('2', 781, 'MS', 439725000, 19667, 16, 8, 4, False, True, "RAK3172-2"),
                        ChannelData('3', 781, 'MS', 439750000, 19667, 16, 8, 4, False, True, "RAK3172-2"),
                        ChannelData('4', 781, 'MS', 439775000, 19667, 16, 8, 4, False, True, "RAK3172-2"),
                        ChannelData('5', 781, 'MS', 439800000, 19667, 16, 8, 4, False, True, "RAK3172-2"),
                        ChannelData('6', 781, 'MS', 439825000, 19667, 16, 8, 4, False, True, "RAK3172-2"),
                        ChannelData('7', 781, 'MS', 439850000, 19667, 16, 8, 4, False, True, "RAK3172-2"),
                        ChannelData('8', 781, 'MS', 439875000, 19667, 16, 8, 4, False, True, "RAK3172-2"),
                        ChannelData('9', 781, 'MS', 439900000, 19667, 16, 8, 4, False, True, "RAK3172-2"),
                        ChannelData('10', 781, 'MS', 439925000, 19667, 16, 8, 4, False, True, "RAK3172-2"),
                        ChannelData('11', 781, 'MS', 439950000, 19667, 16, 8, 4, False, True, "RAK3172-2"),
                        ChannelData('12', 781, 'MS', 439975000, 19667, 16, 8, 4, False, True, "RAK3172-2"),

                        ChannelData('1', 1367, 'S', 439700000, 11236, 16, 7, 4, False, True, "RAK3172-2"),
                        ChannelData('2', 1367, 'S', 439725000, 11236, 16, 7, 4, False, True, "RAK3172-2"),
                        ChannelData('3', 1367, 'S', 439750000, 11236, 16, 7, 4, False, True, "RAK3172-2"),
                        ChannelData('4', 1367, 'S', 439775000, 11236, 16, 7, 4, False, True, "RAK3172-2"),
                        ChannelData('5', 1367, 'S', 439800000, 11236, 16, 7, 4, False, True, "RAK3172-2"),
                        ChannelData('6', 1367, 'S', 439825000, 11236, 16, 7, 4, False, True, "RAK3172-2"),
                        ChannelData('7', 1367, 'S', 439850000, 11236, 16, 7, 4, False, True, "RAK3172-2"),
                        ChannelData('8', 1367, 'S', 439725000, 11236, 16, 7, 4, False, True, "RAK3172-2"),
                        ChannelData('9', 1367, 'S', 439900000, 11236, 16, 7, 4, False, True, "RAK3172-2"),
                        ChannelData('10', 1367, 'S', 439925000, 11236, 16, 7, 4, False, True, "RAK3172-2"),
                        ChannelData('11', 1367, 'S', 439950000, 11236, 16, 7, 4, False, True, "RAK3172-2"),
                        ChannelData('12', 1367, 'S', 439975000, 11236, 16, 7, 4, False, True, "RAK3172-2"),
                    ]
    ...
    @classmethod
    def get_timeonair(cls, spreadingFactor: int, rfBw: int, codeRate: int, lowDatarateOptimize: bool, header: bool, CRCOn: bool, DRF1268DSCompatMode: bool, loraModule: str) -> TimeOnAirData | None:
        cls.init()
        sql = (f"SELECT * FROM TimeOnAirData WHERE SpreadingFactor = {spreadingFactor} and RfBw = {rfBw} and CodeRate = {codeRate} and LowDatarateOptimize = {lowDatarateOptimize} "
               f"and header = {header} and CRCOn = {CRCOn} and DRF1268DSCompatMode = {DRF1268DSCompatMode} and LoraModem = '" + loraModule + "'")
        rows = cls.db.get_table_objects_by_SQL(ChannelData, sql)
        if len(rows) >= 1:
            return rows[0]
        return None
    ...
    def add_timeonair(cls):
        ...
        if not cls.get_timeonair_exists():
            ...
            timeOnAirDatas = [
                        ...
                        # Non compat mode, but still 31.25 kHz, missing for other codingrates....!
                        # RfBW = 7 => 31,25 kHz on RAK3172, CodingRate 1 = 4/5
                        ...
                        TimeOnAirData(7, 7, 1, True, True, False, 8, False, "RAK3172", 206, 309, 145, 227, 186),
                        ...
                        TimeOnAirData(7, 4, 1, True, True, False, 8, False, "RAK3172", 618, 925, 434, 679, 556),
                        TimeOnAirData(6, 4, 1, True, True, False, 8, False, "RAK3172", 383, 567, 260, 383, 321),
                        TimeOnAirData(5, 4, 1, True, True, False, 8, False, "RAK3172", 222, 345, 146, 238, 192),
                        ...
                        TimeOnAirData(7, 4, 2, True, True, False, 8, False, "RAK3172", 692, 1060, 470, 765, 618),
                        TimeOnAirData(6, 4, 2, True, True, False, 8, False, "RAK3172", 432, 653, 285, 432, 358),
                        TimeOnAirData(5, 4, 2, True, True, False, 8, False, "RAK3172", 253, 401, 161, 271, 216),
                        ...
                        # Fixed lenght, no header mode, CodingRate 0
