...
#read line
#install Python-2
wget -O WiRoc-Python-2.tar.gz https://github.com/henla464/WiRoc-Python-2/archive/v0.30.tar.gz
rm -rf WiRoc-Python-2
tar xvfz WiRoc-Python-2.tar.gz WiRoc-Python-2-0.30
mv WiRoc-Python-2-0.30 WiRoc-Python-2
