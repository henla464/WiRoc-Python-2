...
#read line
#install Python-2
wget -O WiRoc-Python-2.tar.gz https://github.com/henla464/WiRoc-Python-2/archive/v0.72.tar.gz
rm -rf WiRoc-Python-2
tar xvfz WiRoc-Python-2.tar.gz WiRoc-Python-2-0.72
mv WiRoc-Python-2-0.72 WiRoc-Python-2

echo "WiRoc-BLE"
#read line
#install WiRoc-BLE
wget -O WiRoc-BLE-Device.tar.gz https://github.com/henla464/WiRoc-BLE-Device/archive/v0.14.tar.gz
rm -rf WiRoc-BLE-Device
tar xvfz WiRoc-BLE-Device.tar.gz WiRoc-BLE-Device-0.14
mv WiRoc-BLE-Device-0.14 WiRoc-BLE-Device
