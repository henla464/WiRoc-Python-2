...
#Channels
    @classmethod
    def get_channel(cls, channel, dataRate, loraModem):
        cls.init()
        sql = ("SELECT * FROM ChannelData WHERE Channel = " + str(channel) +
               " and DataRate = " + str(dataRate) + " and LoraModem = '" + str(loraModem) + "'")
    ...
    def add_default_channels(cls):
        ...
        channels = []
        # =========================      RF1276T      ==============================
        channels.append(ChannelData(1, 293, 439750000, 52590, 16, 12, 7, "RF1276T"))
        channels.append(ChannelData(2, 293, 439775000, 52590, 16, 12, 7, "RF1276T"))
        channels.append(ChannelData(3, 293, 439800000, 52590, 16, 12, 7, "RF1276T"))
        channels.append(ChannelData(4, 293, 439825000, 52590, 16, 12, 7, "RF1276T"))
        channels.append(ChannelData(5, 293, 439850000, 52590, 16, 12, 7, "RF1276T"))
        channels.append(ChannelData(6, 293, 439875000, 52590, 16, 12, 7, "RF1276T"))
        channels.append(ChannelData(7, 293, 439900000, 52590, 16, 12, 7, "RF1276T"))
        channels.append(ChannelData(8, 293, 439925000, 52590, 16, 12, 7, "RF1276T"))

        channels.append(ChannelData(1, 537, 439750000, 24130, 16, 11, 7, "RF1276T"))
        channels.append(ChannelData(2, 537, 439775000, 24130, 16, 11, 7, "RF1276T"))
        channels.append(ChannelData(3, 537, 439800000, 24130, 16, 11, 7, "RF1276T"))
        channels.append(ChannelData(4, 537, 439825000, 24130, 16, 11, 7, "RF1276T"))
        channels.append(ChannelData(5, 537, 439850000, 24130, 16, 11, 7, "RF1276T"))
        channels.append(ChannelData(6, 537, 439875000, 24130, 16, 11, 7, "RF1276T"))
        channels.append(ChannelData(7, 537, 439900000, 24130, 16, 11, 7, "RF1276T"))
        channels.append(ChannelData(8, 537, 439925000, 24130, 16, 11, 7, "RF1276T"))

        channels.append(ChannelData(1, 977, 439750000, 15680, 16, 10, 7, "RF1276T"))
        channels.append(ChannelData(2, 977, 439775000, 15680, 16, 10, 7, "RF1276T"))
        channels.append(ChannelData(3, 977, 439800000, 15680, 16, 10, 7, "RF1276T"))
        channels.append(ChannelData(4, 977, 439825000, 15680, 16, 10, 7, "RF1276T"))
        channels.append(ChannelData(5, 977, 439850000, 15680, 16, 10, 7, "RF1276T"))
        channels.append(ChannelData(6, 977, 439875000, 15680, 16, 10, 7, "RF1276T"))
        channels.append(ChannelData(7, 977, 439900000, 15680, 16, 10, 7, "RF1276T"))
        channels.append(ChannelData(8, 977, 439925000, 15680, 16, 10, 7, "RF1276T"))

        channels.append(ChannelData(1, 1758, 439750000, 8714, 15, 9, 7, "RF1276T"))
        channels.append(ChannelData(2, 1758, 439775000, 8714, 15, 9, 7, "RF1276T"))
        channels.append(ChannelData(3, 1758, 439800000, 8714, 15, 9, 7, "RF1276T"))
        channels.append(ChannelData(4, 1758, 439825000, 8714, 15, 9, 7, "RF1276T"))
        channels.append(ChannelData(5, 1758, 439850000, 8714, 15, 9, 7, "RF1276T"))
        channels.append(ChannelData(6, 1758, 439875000, 8714, 15, 9, 7, "RF1276T"))
        channels.append(ChannelData(7, 1758, 439900000, 8714, 15, 9, 7, "RF1276T"))
        channels.append(ChannelData(8, 1758, 439925000, 8714, 15, 9, 7, "RF1276T"))

        channels.append(ChannelData(1, 3125, 439750000, 4793, 15, 8, 7, "RF1276T"))
        channels.append(ChannelData(2, 3125, 439775000, 4793, 15, 8, 7, "RF1276T"))
        channels.append(ChannelData(3, 3125, 439800000, 4793, 15, 8, 7, "RF1276T"))
        channels.append(ChannelData(4, 3125, 439825000, 4793, 15, 8, 7, "RF1276T"))
        channels.append(ChannelData(5, 3125, 439850000, 4793, 15, 8, 7, "RF1276T"))
        channels.append(ChannelData(6, 3125, 439875000, 4793, 15, 8, 7, "RF1276T"))
        channels.append(ChannelData(7, 3125, 439900000, 4793, 15, 8, 7, "RF1276T"))
        channels.append(ChannelData(8, 3125, 439925000, 4793, 15, 8, 7, "RF1276T"))

        channels.append(ChannelData(1, 5470, 439750000, 2736, 15, 7, 7, "RF1276T"))
        channels.append(ChannelData(2, 5470, 439775000, 2736, 15, 7, 7, "RF1276T"))
        channels.append(ChannelData(3, 5470, 439800000, 2736, 15, 7, 7, "RF1276T"))
        channels.append(ChannelData(4, 5470, 439825000, 2736, 15, 7, 7, "RF1276T"))
        channels.append(ChannelData(5, 5470, 439850000, 2736, 15, 7, 7, "RF1276T"))
        channels.append(ChannelData(6, 5470, 439875000, 2736, 15, 7, 7, "RF1276T"))
        channels.append(ChannelData(7, 5470, 439900000, 2736, 15, 7, 7, "RF1276T"))
        channels.append(ChannelData(8, 5470, 439925000, 2736, 15, 7, 7, "RF1276T"))

        #======================
        #                     channel, datarate, freq, slopek, M, rffactor, rfBw, loramodem
        channels.append(ChannelData(1, 73, 439712500, 210410, 16, 12, 5, "DRF1268DS"))
        channels.append(ChannelData(2, 73, 439762500, 210410, 16, 12, 5, "DRF1268DS"))
        channels.append(ChannelData(3, 73, 439812500, 210410, 16, 12, 5, "DRF1268DS"))
        channels.append(ChannelData(4, 73, 439862500, 210410, 16, 12, 5, "DRF1268DS"))
        channels.append(ChannelData(5, 73, 439912500, 210410, 16, 12, 5, "DRF1268DS"))
        channels.append(ChannelData(6, 73, 439962500, 210410, 16, 12, 5, "DRF1268DS"))

        channels.append(ChannelData(1, 134, 439712500, 114626, 16, 11, 5, "DRF1268DS"))
        channels.append(ChannelData(2, 134, 439762500, 114626, 16, 11, 5, "DRF1268DS"))
        channels.append(ChannelData(3, 134, 439812500, 114626, 16, 11, 5, "DRF1268DS"))
        channels.append(ChannelData(4, 134, 439862500, 114626, 16, 11, 5, "DRF1268DS"))
        channels.append(ChannelData(5, 134, 439912500, 114626, 16, 11, 5, "DRF1268DS"))
        channels.append(ChannelData(6, 134, 439962500, 114626, 16, 11, 5, "DRF1268DS"))

        channels.append(ChannelData(1, 244, 439712500, 62950, 16, 10, 5, "DRF1268DS"))
        channels.append(ChannelData(2, 244, 439762500, 62950, 16, 10, 5, "DRF1268DS"))
        channels.append(ChannelData(3, 244, 439812500, 62950, 16, 10, 5, "DRF1268DS"))
        channels.append(ChannelData(4, 244, 439862500, 62950, 16, 10, 5, "DRF1268DS"))
        channels.append(ChannelData(5, 244, 439912500, 62950, 16, 10, 5, "DRF1268DS"))
        channels.append(ChannelData(6, 244, 439962500, 62950, 16, 10, 5, "DRF1268DS"))

        channels.append(ChannelData(1, 439, 439712500, 34988, 16, 9, 5, "DRF1268DS"))
        channels.append(ChannelData(2, 439, 439762500, 34988, 16, 9, 5, "DRF1268DS"))
        channels.append(ChannelData(3, 439, 439812500, 34988, 16, 9, 5, "DRF1268DS"))
        channels.append(ChannelData(4, 439, 439862500, 34988, 16, 9, 5, "DRF1268DS"))
        channels.append(ChannelData(5, 439, 439912500, 34988, 16, 9, 5, "DRF1268DS"))
        channels.append(ChannelData(6, 439, 439962500, 34988, 16, 9, 5, "DRF1268DS"))

        channels.append(ChannelData(1, 781, 439712500, 19667, 16, 8, 5, "DRF1268DS"))
        channels.append(ChannelData(2, 781, 439762500, 19667, 16, 8, 5, "DRF1268DS"))
        channels.append(ChannelData(3, 781, 439812500, 19667, 16, 8, 5, "DRF1268DS"))
        channels.append(ChannelData(4, 781, 439862500, 19667, 16, 8, 5, "DRF1268DS"))
        channels.append(ChannelData(5, 781, 439912500, 19667, 16, 8, 5, "DRF1268DS"))
        channels.append(ChannelData(6, 781, 439962500, 19667, 16, 8, 5, "DRF1268DS"))

        channels.append(ChannelData(1, 1367, 439712500, 11236, 16, 7, 5, "DRF1268DS"))
        channels.append(ChannelData(2, 1367, 439762500, 11236, 16, 7, 5, "DRF1268DS"))
        channels.append(ChannelData(3, 1367, 439812500, 11236, 16, 7, 5, "DRF1268DS"))
        channels.append(ChannelData(4, 1367, 439862500, 11236, 16, 7, 5, "DRF1268DS"))
        channels.append(ChannelData(5, 1367, 439912500, 11236, 16, 7, 5, "DRF1268DS"))
        channels.append(ChannelData(6, 1367, 439962500, 11236, 16, 7, 5, "DRF1268DS"))
